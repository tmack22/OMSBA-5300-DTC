...
| Variable |  Definition
|:------    |:-------------------------------------------------     | 
| `period_type` | Identifies if the survey was taken. There are 3 periods: Before COVID (Pre-March 2020), during COVID (during March 2020), and after COVID (Post-March 2020) |
| `date_` | Date that the survey was taken. |
| `is_employed` | Flag to note if the respondent was employed or not. |
| `WTFINL` | Survey person weight (as calculated by CPS)
| `IND`  | Respondent's work industry code |
| `indname` | Respondent's work industry name |
| `REGION` | Respondents location (regional) |
| `AGE`  | Respondent's age |
| `sex` |  Respondent sex assigned at birth|
