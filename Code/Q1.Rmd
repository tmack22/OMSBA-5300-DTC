...
| `covidunaw` ="covid impact" | could respondent's unemployment be attributed to COVID-19 |
...
* categorize the `q1_employment` data into `rationale` (for reasons why they are unemployed) categories to look at which employment changed into three levels:
